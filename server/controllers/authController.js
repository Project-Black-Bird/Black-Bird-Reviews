    ...
    transporter.sendMail(
      {
        ...
        text:
          "Welcome to Black Bird Reviews, Thank you for signing up with us. We hope to hear your thoughts on products you want to review soon!",
      },
      (err, success) => {
        if (err) {
          console.log(err);

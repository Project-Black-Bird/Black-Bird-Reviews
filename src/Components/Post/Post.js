                ...
                <button
                  ...
                  <svg
                    ...
                    <g fill="#2a7180">
                      ...
                      <path
                        fill="#2a7180"
                        d="M20,10h-5V7c0-1.7-1-4-2.5-4.9C11.8,1.8,11,2.2,11,3v4l-3,3.6V21l0.3,0.1C9.4,21.7,10.7,22,12,22h7 c1.1,0,2-0.9,2-2l1-8C22,10.9,21.1,10,20,10z"></path>
                    </g>
                  </svg>
                ...
                <button type="action-buttons" className="action-buttons">
                  <svg
                    ...
                    <g fill="#2a7180">
                      <polygon
                        fill="#2a7180"
                        points="6,8 12,1 18,8 13,8 13,17 11,17 11,8 "></polygon>{" "}
